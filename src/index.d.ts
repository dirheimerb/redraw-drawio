...
export type EventUnion<E extends EventKey> = {
  event: E;
} & EventMap[E];
...
export declare const DrawIOEmbed: import('react').ForwardRefExoticComponent<
  Omit<DrawIoEmbedProps, 'ref'> & import('react').RefAttributes<DrawIoEmbedRef>
>;
